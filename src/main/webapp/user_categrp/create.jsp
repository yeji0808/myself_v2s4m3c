  ...
  <fieldset class='fieldset_basic'>
    <ul>
      <li class='li_none'>
        ...
        <input type='text' name='user_name' value='' required="required" autofocus="autofocus">
      </li>
      <li class='li_none'>
      ...
      <li class='li_none'>
        ...
        <input type='number' name='user_cnt' value='1' required="required" placeholder="${cnt }" min="1" max="100" step="1" style='width: 70%;'>
      </li>
      <li class='li_none'>
        <label>형식</label>
        <select name='visible'>
