...
<script type="text/javascript">
  function update_image(somoimno) {
	  var url = './update_image.do?somoimno=' + somoimno;
  ...
  <DIV class='top_menu'>
    ...
    <NAV class='top_menu_list' style='text-align: center;'>
      ...
      <A class='menu_link'  href=''> 
        <span class="glyphicon glyphicon-calendar" style='color: #ffffff'></span> 일정 </A> <span class='top_menu1'></span>    
      <A class='menu_link'  href=''> 
        <span class="glyphicon glyphicon-user" style='color: #ffffff'></span> 회원목록 </A>
    </NAV>
  </DIV>
