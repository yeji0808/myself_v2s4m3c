  ...
  <DIV style='margin-left: 30%; margin-top: 5%; width: 50%;'>
    <FORM name='frm' method='POST' action='./create_menu.do' enctype="multipart/form-data"  class="form-horizontal">
      ...
      <div class="form-group" >        
        ...
        <input type="text" class="form-control-lg" required="required" name="mname" style="width: 30%;"placeholder="메뉴명"><input type="text" class="form-control-lg" required="required" name="mprice" style="width: 20%;"placeholder="가격">
