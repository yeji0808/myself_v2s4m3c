...
<title>delete_by_wno_msg.jsp</title>
    ...
    <UL>
      <c:choose>
        <c:when test="${param.count > 0 }">
          ...
          <LI class='li_none'>
            <button type='button'  
                        onclick="location.href='../write/delete.do?wno=${param.wno}&boardno=${param.boardno}'"
                        class="btn btn-info">계속 삭제 진행</button>
            <button type='button' 
                        onclick="location.href='../write/read.do?boardno=${param.boardno}&wno=${param.wno }'"
